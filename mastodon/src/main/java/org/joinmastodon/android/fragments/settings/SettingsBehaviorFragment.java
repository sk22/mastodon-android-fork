...
public class SettingsBehaviorFragment extends BaseSettingsFragment<Void> implements HasAccountID{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		List<ListItem<Void>> items = new ArrayList<>(List.of(
				...
				overlayMediaItem=new CheckableListItem<>(R.string.sk_settings_continues_playback, R.string.sk_settings_continues_playback_summary, CheckableListItem.Style.SWITCH, GlobalUserPreferences.overlayMedia, R.drawable.ic_fluent_dual_screen_speaker_24_filled, ()->toggleCheckableItem(overlayMediaItem)),
