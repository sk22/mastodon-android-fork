...
public class OnboardingProfileSetupFragment extends ToolbarFragment{
	...
	public View onCreateContentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
		...
		discoverableItem=new CheckableListItem<>(R.string.make_profile_discoverable, 0, CheckableListItem.Style.SWITCH_SEPARATED, true, 0 /* R.drawable.ic_campaign_24px */, item->showDiscoverabilityAlert());
